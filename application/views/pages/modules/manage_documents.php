                    ...
                    <div class="container x_content">
                    	<form id="document_uploadForm">
                    		<div class="w3-col l12">
                    			...
                    			<div class="col-md-4 w3-margin-top w3-small" >
                           	...
                           	<div id="body">
                           		<div id="container">
                           			<div class="form-group w3-center">
                           				<button id="upload" href="javascript:;" type="submit" class="w3-button theme_bg">Click here to Submit</button>
                           			</div>
                           		</div>
                           	</div>
                           </div>
       											...
       											<div class="modal-body">
       												...
       												<div class="container"> 
       													<div class="col-lg-12">
       														...
       														<?php
       														$image_arr = $doc['document_file'];
       														?>                                
       														<div class="w3-col l12 w3-padding">
       															<?php
       															
       																$arr = explode('/', $image_arr);
       																$filename = $arr[1];
       																...
       																<div class="w3-padding-small" style="display: inline;">
       																	<a class="w3-text-grey btn w3-round"  target="_self" href="<?php echo base_url() . $image_arr; ?>"  download="<?php echo 'File_' . $filename; ?>" title="Download <?php echo $filename; ?>" style="padding:4px;display: inline-block;"><b></b><i class="fa <?php echo $image; ?> w3-jumbo"></i></a>
       																</div>
