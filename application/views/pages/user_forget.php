                ...
                <div class="col-md-6 col-md-offset-3 " >
                    <div class="panel panel-login" style="padding: 20px">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-12">
                                    <a href="#" class="active" id="admin_login-form-link">User Forget Password</a>
                                </div>
                            </div>
                            <hr>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="userForgetForm" role="form" style="display: block;">
                                        <div id="adminOutput"></div>
                                        <div class="form-group">
                                            <input type="email" name="user_email" id="user_email" tabindex="1" class="form-control" placeholder="Enter your Email Id here" value="">
                                        </div>
...
<script>
    $(function () {
        $("#userForgetForm").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: BASE_URL + "user_forgetpassword/getPassword",
                dataType: 'text',
                data: dataString,
