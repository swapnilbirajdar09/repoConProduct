                                        ...
                                        if ($rolename = $val['requested_from'] || $role == 'company_admin') {
                                            ...
                                            <tr class="w3-center">
                                                ...
                                                <td style=" vertical-align: middle;">
                                                    <div class="btn-group">
                                                        <?php if ($val['status'] == '0') { ?>
                                                            <a id="actionBtn_<?php echo $val['request_id']; ?>" href="<?php echo base_url(); ?>user_dashboard/uploadDocument/<?php echo base64_encode($val['request_id'] . '/' . $val['document_name'] . '/' . $val['requested_by']); ?>" class="btn w3-small w3-blue" style="padding: 2px 6px">Upload Document</a>
                                                        <?php } else { ?>
                                                            <a id="" class="btn w3-small w3-blue" style="padding: 2px 6px" disabled="disabled">Document Uploaded</a>
                                                            <?php } ?>
                                                            <!--                                                        <ul role="menu" class="dropdown-menu pull-right">              
                                                                                                                        <li>
