                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>modules/request_module"><i class="fa fa-question-circle"></i> Request Module </a></li>
                                        ...
                                        foreach ($features['status_message'] as $key) {
                                            ...
                                            if (in_array($grade_id, $gradlist)) {
                                                ...
                                                if ($key['feature_name'] == 'Document controller') {
                                                    ...
                                                    $symbole = 'question';
                                                }if ($key['feature_name'] == 'Request Document') {
                                                    $symbole = 'question-circle';
                                                }
                                                ?>
