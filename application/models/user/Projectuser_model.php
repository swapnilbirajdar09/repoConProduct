...
class Projectuser_model extends CI_Model {
    ...
    public function createNewUser($data) {
        ...
        if ($this->db->query($sql)) {
            $emailsend = Projectuser_model::sendEmail($userFirstName, $role_name, $userLastName, $userEmail, $username, $userPassword);
            return TRUE;
        } else {
            return FALSE;
        }
    ...
    public function sendEmail($userFirstName, $role_name, $userLastName, $userEmail, $username, $userPassword) {
        ...
        $this->email->message('<html>
            ...
            <h3 style="font-size:15px;"> Your Login Credentials For !.<br><br>Thank you for contacting us, we will reply to your inquiry as soon as possible!</h3>
            <div class="col-lg-12">
